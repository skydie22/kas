...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            ...
            <p class="auth-subtitle mb-5">Login dengan data yang sudah di sediakan.</p>

            <form method="POST" need-validation action="{{ route('login') }}">
                @csrf
                <div class="form-group position-relative has-icon-left mb-4">
                    <input asp-for="email" type="email" name="email"class="form-control form-control-xl @error('email') is-invalid @enderror"
                            placeholder="Email">
